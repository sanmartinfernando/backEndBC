...
class WebpackCompiler {
    ...
    run(configuration, webpackConfigFactoryOrConfig, tsConfigPath, appName, isDebugEnabled = false, watchMode = false, onSuccess) {
        ...
        const pathToSource = sourceRoot.indexOf(relativeRootPath) >= 0
        ...
        const compiler = webpack(Object.assign(Object.assign({}, defaultOptions), projectWebpackOptions));
