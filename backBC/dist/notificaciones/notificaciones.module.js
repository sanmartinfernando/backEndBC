...
const notificaciones_providers_1 = require("./notificaciones.providers");
...
NotificacionesModule = __decorate([
    common_1.Module({ imports: [database_module_1.DatabaseModule, nest_morgan_1.MorganModule.forRoot()],
        controllers: [notificaciones_controller_1.NotificacionesController],
        providers: [notificaciones_service_1.NotificacionesService, ...notificaciones_providers_1.notifiProviders] })
