...
class BuildAction extends abstract_action_1.AbstractAction {
    constructor() {
        ...
        this.tsConfigProvider = new tsconfig_provider_1.TsConfigProvider();
        this.compiler = new compiler_1.Compiler(this.pluginsLoader, this.tsConfigProvider);
        this.webpackCompiler = new webpack_compiler_1.WebpackCompiler(this.pluginsLoader);
        this.watchCompiler = new watch_compiler_1.WatchCompiler(this.pluginsLoader);
    ...
    handle(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.runBuild(inputs, options, watchMode);
            }
            catch (err) {
    ...
    runBuild(inputs, options, watchMode, isDebugEnabled = false, onSuccess) {
        return __awaiter(this, void 0, void 0, function* () {
